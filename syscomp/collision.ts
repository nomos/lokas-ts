...
export function circleCircle (a,b,contact = null) {
...
export function polygonPolygon (a,b,contact) {
...
export function polygonCircle(a, b, contact = null, reverse = false) {
    const a_coords       = a._coords;
...
export function separatingAxis (a_coords, b_coords, x, y, contact = null) {
